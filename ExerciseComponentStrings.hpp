...
#define RNDM_INTRO "This piece of code will generate a random number by passing the minimum and maximum as constant reference values, and a third value as a reference"
#define RNDM_RPT "Make more random numbers"

#define STR_TITLE "Compare Strings by Reference"
#define STR_INTRO "This piece of code will compare two strings to determine if they are the same, letter by letter, they will be passed by reference"
